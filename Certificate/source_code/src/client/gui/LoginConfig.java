...
public class LoginConfig extends JFrame {
	...
	public JPanel panel;
	/**
	 * @uml.property  name="panelLogin"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
	public JPanel panelLogin;
	/**
	 * @uml.property  name="panelConfig"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
	...
	/**
	 * @uml.property  name="btnConfigConnect"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
	public JButton btnConfigConnect;
	/**
	 * @uml.property  name="btnBackToLogin"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
	public JButton btnBackToLogin;
	/**
	 * @uml.property  name="btnConfig"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
	public JButton btnConfig;

	/**
	 * @uml.property  name="lblForgotPass"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
