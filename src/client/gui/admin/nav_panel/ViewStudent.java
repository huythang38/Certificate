...
import client.event.admin.StudentInfoEvent;
...
public class ViewStudent extends JPanel {
	...
	public static SearchPanelStudentInfoEvent searchPanelEvent;
	...
	public StudentInfoEvent event = new StudentInfoEvent();
	...
	public static JTextField txtCandidate;
	public static JTextField txtCourse;
	public static JTextField txtClass;

	public ViewStudent() {
		setLayout(new BorderLayout(0, 0));
		searchPanelEvent = new SearchPanelStudentInfoEvent();
		{
		...
		JPanel panel = new JPanel();
		{
			...
			JLabel lblUpdateStudent = new JLabel("Student info:");
			...
			frmtdtxtfldPhone.setEditable(false);
		...
		JScrollPane scrollPaneFrame = new JScrollPane();
		{
			...
			txtCandidate = new JTextField();
			txtCandidate.setEditable(false);
			txtCandidate.setText("candidate");
			txtCandidate.setBounds(118, 301, 137, 25);
			panel.add(txtCandidate);
			txtCandidate.setColumns(10);

			txtCourse = new JTextField();
			txtCourse.setEditable(false);
			txtCourse.setText("Course");
			txtCourse.setBounds(118, 337, 137, 25);
			panel.add(txtCourse);
			...
			txtClass.setBounds(118, 373, 137, 25);
			panel.add(txtClass);
	...
	public static void setContentToPanel(String id, String lock, String name,
			String address, String gender, String birthday, String email,
			String phone, String candidate, String _class, String course) {
